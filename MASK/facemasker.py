...
class FaceMasker:
    ...
    def __init__(self, face_path, mask_path, out_path, show=False, model='hog'):
        ...
        masks = []
        maskName=[]
        for dir_ in glob.iglob("images/*.png"):
            masks.append(Image.open(dir_))
            maskName.append(dir_.split("/")[-1].strip(".png"))
    ...
    def _mask_face(self, face_landmark: dict):
        ...
        for i in range(len(self.masks)):
            ...
            tmp.save(self.out_path+"/"+self.face_path.split("/")[-1].strip(".jpg") + "__"+self.maskName[i]+"__"+ ".jpg")
